...
QtObject {
    ...
    readonly property color onSurface: "#FFF0ECF4"
    readonly property color onSurfaceVariant: "#FFC9C3CE"
    ...
    readonly property color onPrimary: "#FF381E72"
    readonly property color primaryContainer: "#FF4F378B"
    readonly property color onPrimaryContainer: "#FFEADDFF"
